...
<body onload="fn_on()">
	...
	<br>
		...
		<main class="form-signin w-100 m-auto">
			...
			<form action="commuInsertOK.do" method="post">
			
				<div class="mb-3 mt-5 row">
					<div class="col">
						<input type="text" class="form-control" id="comm_title" name="comm_title" placeholder="제목을 입력해주세요 :)" value="">
					</div>				
				</div>
				<div>
					<textarea id="summernote" name="comm_content" placeholder="OPTIC YELLOW"></textarea>
				</div>
