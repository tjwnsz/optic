            		...
            		<div class="mx-auto p-3 bg-body rounded shadow-sm list-item" id="list-base">
            			<div class="d-flex flex-row text-body-secondary justify-content-between align-items-center">            	
            				<div class="flex-wrap p-2 fs-6 justify-content-center" style="width:20%; text-align:center;">            				
            					<a href="#" class="p-2" style="flex: 1; text-align: center;" onclick="openPopup('r_adv_selectOne.do?r_num=\${vo2[i].r_num}')"><strong> \${vo2[i].r_num}</strong></a>
            				</div>
            				<a href="#" class="p-2" style="flex: 1; text-align: center;" onclick="openPopup('r_adv_selectOne.do?r_num=\${vo2[i].r_num}')">신고 제목: \${vo2[i].r_name}</a>
            					<a href="#" class="p-2" style="flex: 1; text-align: center;">신고사유: \${vo2[i].r_reason}</a>
            					<a href="#" class="p-2" style="flex: 1; text-align: center;">신고자: \${vo2[i].r_name}</a>
            					<a href="#" class="p-2" style="flex: 1; text-align: center;">신고날짜: \${vo2[i].r_date}</a>
            					<a href="p_selectOne.do?p_num=\${vo2[i].p_num}" class="p-2" style="flex: 1; text-align: center;">신고물품: \${vo2[i].p_name}</a>            					
