...
$(function(){
    ...
    $.ajax({
        ...
        success : function(vo2) {
            ...
            console.log(vo2.p_num,vo2.b_granted);
            
            var sellerInfoLink = document.getElementById("sellerInfoLink");
            sellerInfoLink.href = "cb_selectOne.do?p_num=" + vo2.p_num;
            sellerInfoLink.innerText = "판매자 정보 확인하기";
...
function goFinalDicision() {
    ...
    if (confirm("상품구매를 확정하시겠습니까?!")) {
    	location.href = "b_p_finalOK.do?p_num=" + pNum;
        alert("상품구매가 확정되었습니다. 판매자의 확정현황은 ~에서 확인하실 수 있습니다.");
    }
}
...
function AlreadyConfirm(b_confirm){
	console.log(b_confirm)
...
<td><input id="p_num" name="p_num" type="hidden"></td>
	...
	<h5><a id="sellerInfoLink" href="#">판매자 정보 확인하기</a></h5>
</body>
</html>
