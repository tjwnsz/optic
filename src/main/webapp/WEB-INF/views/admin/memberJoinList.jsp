...
<script type="text/javascript">
				...
				$('#userId').html(change_txt);
	 			...
	 			let thead = `
	 				<thead class="table-light">
		 			    <tr>
							<th scope="col" class="col-1-w">🚩 매치장소</a></th>
							<th scope="col" class="col-2-w">🎾 매치명</th>
							<th scope="col" class="col-3-w">🥎 매치인원</th>
							<th scope="col" class="col-4-w">🕒 모집상태</th>
		 			    </tr>
					</thead>
	 			`;
	 			...
	 			tag_vos += `
	 					<tr>
							<td scope="col" class="col-1-w"><a href="g_selectOne.do?g_num=\${vo.g_num}">\${vo.fac_name}</a></td>
							<td scope="col" class="col-2-w"><a href="g_selectOne.do?g_num=\${vo.g_num}">\${vo.g_name}</a></td>
							<td scope="col" class="col-3-w"><a href="g_selectOne.do?g_num=\${vo.g_num}">\${vo.g_amount}명</a></td>
							<td scope="col" class="col-4-w"><a href="g_selectOne.do?g_num=\${vo.g_num}">\${g_open}</a></td>
						</tr>
	 			`;
	...
	function fn_prev(page, range, rangeSize) {
		...
		var url = "memberJoinList.do?m_num="+${param.m_num};
		url = url + "&page=" + page;
		url = url + "&range=" + range;
		location.href = url;
	} // end fn_prev()......
...
<body onload="fn_on()" style="height:100%;">
	...
	<main class="container" style="height:1200px;">	
		...
		<span style="cursor:pointer;color:#000;" 
			...
			onmouseout="this.style.color='#000';" onclick="m_gameResList()">신청한 매치</span>
		<span>｜</span>
		<span style="cursor:pointer;color:#000;" 
			onmouseover="this.style.color='#3C7DEF';" 
			onmouseout="this.style.color='#000';" onclick="location.href='memberResList.do?m_num=${param.m_num}'">예약한 코트</span>		
		<hr>
		<br>
