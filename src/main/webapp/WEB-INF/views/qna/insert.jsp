...
<body onload="fn_on()">
	...
	<div class="container" style="height:650px;">
		<main class="form-signin w-100 m-auto">
			<div class="fs-2 text-center"><strong>📣 1:1 문의 등록 📣</strong></div>
			
			<form action="qna_insertOK.do" method="post" onsubmit="return fn_action()">
			
				<div class="mb-3 mt-5 row">
					<div class="col">
						<input type="text" class="form-control" id="q_title" name="q_title" placeholder="제목을 입력해주세요 :)" value="">
					</div>				
				</div>
				<div>
					<textarea id="summernote" name="q_content" placeholder="문의 내용을 작성해주세요."></textarea>
				</div>
