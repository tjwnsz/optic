	...
	$(function() {
		$.ajax({
			...
			success : function(vo2) {
				...
				$('#span_id').val(vo2.register_id);
				$('#span_facid').val(vo2.fac_id);
				$('#fac_name').val(vo2.fac_name);
				$('#address').val(vo2.address);
				$('#court_no').val(vo2.court_no);
				$("#in_or_out").val(vo2.in_or_out).prop("selected", true);
				$("#floor_type").val(vo2.floor_type).prop("selected", true);
				$("#open_time").val(vo2.open_time).prop("selected", true);
				$("#close_time").val(vo2.close_time).prop("selected", true);
				$('#come').val(vo2.come);
				$('#c_price').val(vo2.c_price);
				$('#c_price').val(vo2.c_price);
				$('#span_pic1').text(vo2.court_pic1);
				$('#span_pic2').text(vo2.court_pic2);
				$('#span_pic3').text(vo2.court_pic3);
...
<body>
	...
	<form action="fac_updateOK.do" method="post" onsubmit="return fn_action()"
		enctype="multipart/form-data">
		
		<div class="mb-3 row">
			<label for="fac_id" class="col-lg-2 col-form-label">테니스장 ID:</label>
			<div class="col-lg-10">
				<input type="text" readonly class="form-control-plaintext"
					id="span_facid" name="fac_id" value="">
			</div>
		</div>
		
		<div class="mb-3 row">
			<label for="register_id" class="col-lg-2 col-form-label">테니스장 등록자:</label>
			<div class="col-lg-10">
				<input type="text" readonly class="form-control-plaintext"
					id="span_id" name="register_id" value="">
			</div>
		</div>
		...
		<div class="mb-3 row">
			<span class="notice">테니스장 주소</span>
			<div class="col-sm-9">
		...
		<div class="mb-3 row">
			<label for="conv"><h3>편의 시설</h3></label>
				...
				<div class="form-check col-sm-3">
					<input class="form-check-input" type="checkbox" id="conv" name="conv" value="유료주차장">
		...
		<div class="mb-3 row col-9">
			<div class="input-group">
  				...
  				<textarea class="form-control" aria-label="With textarea" id="come" rows="10" cols="20" name="come"></textarea>
			</div>
		</div>
