...
<script type="text/javascript">
	function fn_action() {
		console.log(document.getElementById('m_id').value);
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
	...
	<main class="form-signin w-100 m-auto">
		<form name="frm" action="findPwOK.do" method="post"
			...
			<div class="input-group mb-3">
				<input type="text" class="form-control" id="m_id" name="m_id"
					style="border-radius: 5px;" value="" placeholder="아이디">
			</div>
			<div class="input-group mb-3">
		...
		<br>
		<div align="center">
			<a href="login.do" class="mt-5 mb-3 text-body-secondary">로그인</a> <span>｜</span>
			<a href="findId.do" class="mt-5 mb-3 text-body-secondary">아이디 찾기</a>
			<span>｜</span> <a href="m_insert.do"
				class="mt-5 mb-3 text-body-secondary">회원가입</a>
		</div>
	</main>
	<script
