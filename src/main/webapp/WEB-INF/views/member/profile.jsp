				...
				<div class="col-md-7 col-lg-8">
					...
					<div class="col-12">
						...
						<p>
							...
							<input type="text" class="form-control" id="introduce" name="introduce" placeholder="" value="${vo2.introduce}" required>
					</div>
					<p>
					<div class="row gy-3">
						<div class="col-md-6">
					...
					<p>
					<hr class="col-12">
					<button class="col-12 btn btn-primary btn-lg" id="submitBtn" onclick="location.href='myPage.do?m_id=${user_id}'" type="submit">확인</button>
